...
public class NearbyWordsGraderOne {
    public static void main(String args[]) {
        ...
        try {
            ...
            List<String> d1 = nw.distanceOne("cool", true);
            ...
            feedback += "\n** Test 8: substitutions list size... ";
            nw.subsitution("cool", d1, true);
            feedback += "substitution returned " + d1.size() + " words.\n";

            feedback += "** Test 9: substitution words returned... ";
            feedback += "substitutions returned: ";
            for (String i : d1) {
                feedback += i + ", ";
            }
            feedback += "\n";
